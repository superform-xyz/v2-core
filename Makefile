...
test-vvv :; $(MAKE) ensure-merkle-cache && forge test --match-contract MorphoLoanHooksTest -vvvv --jobs 10
...
test-vvv-quick :; forge test --match-test test_HookPoisoning_DirectCall_DoesNotBreakNormalExecution -vvv --jobs 10
