...
generate:
	...
	abigen --abi out/SuperNativePaymaster.sol/SuperNativePaymaster.abi --pkg contracts --type SuperNativePaymaster --out contract_bindings/SuperNativePaymaster.go