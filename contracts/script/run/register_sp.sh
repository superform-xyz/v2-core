...
forge script script/RegisterSuperPositions.s.sol:RegisterSuperPositions --sig "registerSuperPositions(uint64)" 0 \
...
forge script script/RegisterSuperPositions.s.sol:RegisterSuperPositions --sig "registerSuperPositions(uint64)" 1 \
