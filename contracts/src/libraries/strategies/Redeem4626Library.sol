...
library Redeem4626Library {
  /// @notice Error thrown when the asset of the vaults is not the same
  error VAULTS_MUST_HAVE_SAME_UNDERLYING_ASSET();

  /// @notice Gets the price per share for a redeem
  /// @param finalTarget The final target vault to redeem from
  ...
  /// @notice Get the price per share for a redeem from multiple vaults
