...
contract IntentsBasicExecution is IntentsShared {
    ...
    function test_WhenTheAddCollateralExecutorIsCalled(uint256 amount) external whenAccountHasTokens {
        ...
        uint256 collateralBefore = IERC20(address(lendingAndBorrowingProtocolMock)).balanceOf(address(instance.account));
        ...
        uint256 collateralAfter = IERC20(address(lendingAndBorrowingProtocolMock)).balanceOf(address(instance.account));
