...
/// @title TransferMorphoBlueMarketRegistryRoles
/// @notice Script to transfer MorphoBlueMarketRegistry roles from DEPLOYER to governance addresses.
/// @dev Role mapping:
///      - MARKET_MANAGER_ROLE  → GOVERNOR         (operational: register/deregister markets, IRM approval)
...
contract TransferMorphoBlueMarketRegistryRoles is DeployV2Base {
    /*//////////////////////////////////////////////////////////////
                            CONSTANTS
    //////////////////////////////////////////////////////////////*/
    ...
    /// @param registryAddr Address of the deployed MorphoBlueMarketRegistry
    function run(uint256 env, uint64 chainId, address registryAddr) external broadcast(env) {
        ...
        MorphoBlueMarketRegistry registry = MorphoBlueMarketRegistry(registryAddr);

        console2.log("====== Transfer MorphoBlueMarketRegistry Roles ======");
        ...
        console2.log("");
        require(
            registry.hasRole(MARKET_MANAGER_ROLE, GOVERNOR), "TRANSFER_FAILED: GOVERNOR missing MARKET_MANAGER"
        );
        require(
        ...
        require(
            !registry.hasRole(MARKET_MANAGER_ROLE, DEPLOYER), "TRANSFER_FAILED: DEPLOYER still has MARKET_MANAGER"
        );
    ...
    function runCheck(uint256 env, uint64 chainId, address registryAddr) external broadcast(env) {
        ...
        console2.log("====== MorphoBlueMarketRegistry Role Check ======");
        console2.log("Registry:", registryAddr);
        console2.log("Chain ID:", uint256(chainId));
        console2.log("Environment:", env);
    ...
    function _logRoleStatus(
        MorphoBlueMarketRegistry registry,
