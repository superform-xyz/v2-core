...
abstract contract Constants {
    ...
    string internal constant STARGATE_V2_SEND_HOOK_KEY = "StargateV2SendHook";
    string internal constant APPROVE_AND_STARGATE_V2_SEND_HOOK_KEY = "ApproveAndStargateV2SendHook";
