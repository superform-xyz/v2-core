...
interface IYieldSourceOracle {
    ...
    function getShareOutput(address yieldSourceAddress, uint256 assetsIn) external view returns (uint256);
    ...
    function getAssetOutput(address yieldSourceAddress, uint256 sharesIn) external view returns (uint256);
