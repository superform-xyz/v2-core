...
/// @notice Hook for executing swaps via Uniswap V3 SwapRouter02.exactInputSingle
...
contract SwapUniswapV3Router02Hook is
    BaseHook,
    ISuperHookSwap,
    ISuperHookContextAware,
    ISuperHookInflowOutflow,
    ISuperHookOutflow
{
    ...
    /// @notice Initialize the Uniswap V3 SwapRouter02 swap hook
    ...
    function name() external pure override returns (string memory) {
        return "Swap Uniswap V3 Router02";
    }

    /// @notice One-sentence description of what this hook does
    function description() external pure override returns (string memory) {
        return "Swaps tokens via Uniswap V3 Router02";
    }
