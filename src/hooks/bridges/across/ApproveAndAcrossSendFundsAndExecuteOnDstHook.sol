...
/// @title ApproveAndAcrossSendFundsAndExecuteOnDstHook
...
contract ApproveAndAcrossSendFundsAndExecuteOnDstHook is BaseHook, ISuperHookContextAware {
    /*//////////////////////////////////////////////////////////////
                                 STORAGE
    //////////////////////////////////////////////////////////////*/
        ...
        returns (Execution[] memory executions)
    {
        ...
        executions[0] = Execution({
            target: acrossV3DepositAndExecuteData.inputToken,
            value: 0,
        ...
        executions[1] = Execution({
            target: acrossV3DepositAndExecuteData.inputToken,
            value: 0,
            callData: abi.encodeCall(IERC20.approve, (SPOKE_POOL_V3, acrossV3DepositAndExecuteData.inputAmount))
        });
