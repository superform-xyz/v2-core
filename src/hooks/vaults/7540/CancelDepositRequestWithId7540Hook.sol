...
/// @title CancelDepositRequestWithId7540Hook
/// @author Superform Labs
/// @notice Same as CancelDepositRequest7540Hook but with requestId from calldata (non-zero support)
...
contract CancelDepositRequestWithId7540Hook is BaseHook, ISuperHookInflowOutflow {
    ...
    function name() external pure override returns (string memory) {
        return "Cancel Deposit Request with ID ERC-7540";
    }

    /// @notice One-sentence description of what this hook does
    function description() external pure override returns (string memory) {
        return "Cancels a pending deposit request on an ERC-7540 vault using a request ID";
    }
        ...
        returns (Execution[] memory executions)
    {
        ...
        executions[0] = Execution({
            target: yieldSource,
            value: 0,
            callData: abi.encodeCall(IERC7540CancelDeposit.cancelDepositRequest, (requestId, account))
        });
    }
