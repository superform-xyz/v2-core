...
This spec records the finding, the conditions that would reopen the decision, and a sketch of what an integration would require if those conditions are met. Full cited evidence is in `research/protocol-analysis.md`.
