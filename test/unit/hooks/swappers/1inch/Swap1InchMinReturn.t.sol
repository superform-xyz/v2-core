...
contract Swap1InchHookBugTest is Test {
    ...
    function test_Bug_UsePrevHookAmount_UpdatesAmountAndMinReturn() public {
        ...
        assertEq(
            bugDecodeData.minReturn, expectedMinReturn, "MinReturn should be updated based on slippage calculation"
        );
        ...
        returns (bytes memory)
    {
        ...
        return abi.encodePacked(bytes(new bytes(52)), dstToken, dstReceiver, uint256(0), usePrevHookAmount, callData);
    }
