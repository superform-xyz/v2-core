...
contract ApproveAndFluidStakeHookTest is Helpers {
    ...
    function test_ApproveAndFluidStake_ReplaceCalldataAmounts_ThenBuild() public view {
        bytes memory data = _encodeData(false);
    ...
    function test_ApproveAndFluidStake_ReplaceCalldataAmounts_PreservesOtherFields() public view {
        bytes memory data = _encodeData(false);
