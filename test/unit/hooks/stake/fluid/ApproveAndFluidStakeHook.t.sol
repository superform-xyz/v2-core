...
contract ApproveAndFluidStakeHookTest is Helpers {
    ...
    function test_ApproveAndFluidStake_ReplaceCalldataAmount_ThenBuild() public view {
        bytes memory data = _encodeData(false);
    ...
    function test_ApproveAndFluidStake_ReplaceCalldataAmount_PreservesOtherFields() public view {
        bytes memory data = _encodeData(false);
