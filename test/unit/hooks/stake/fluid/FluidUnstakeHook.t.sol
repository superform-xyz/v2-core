...
contract FluidUnstakeHookTest is Helpers {
    ...
    function test_FluidUnstake_ReplaceCalldataAmount_ThenBuild() public view {
        bytes memory data = _encodeData(false);
    ...
    function test_FluidUnstake_ReplaceCalldataAmount_PreservesOtherFields() public view {
        bytes memory data = _encodeData(false);
