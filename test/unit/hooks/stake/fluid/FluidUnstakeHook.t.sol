...
contract FluidUnstakeHookTest is Helpers {
    ...
    function test_FluidUnstake_ReplaceCalldataAmounts_ThenBuild() public view {
        bytes memory data = _encodeData(false);
    ...
    function test_FluidUnstake_ReplaceCalldataAmounts_PreservesOtherFields() public view {
        bytes memory data = _encodeData(false);
