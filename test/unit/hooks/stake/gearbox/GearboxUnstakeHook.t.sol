...
contract GearboxUnstakeHookTest is Helpers {
    ...
    function test_GearboxUnstake_ReplaceCalldataAmounts_ThenBuild() public view {
        bytes memory data = _encodeData(false);
    ...
    function test_GearboxUnstake_ReplaceCalldataAmounts_PreservesOtherFields() public view {
        bytes memory data = _encodeData(false);
