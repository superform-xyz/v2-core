...
contract GearboxStakeHookTest is Helpers {
    ...
    function test_GearboxStake_ReplaceCalldataAmounts_ThenBuild() public view {
        bytes memory data = _encodeData(false);
    ...
    function test_GearboxStake_ReplaceCalldataAmounts_PreservesOtherFields() public view {
        bytes memory data = _encodeData(false);
