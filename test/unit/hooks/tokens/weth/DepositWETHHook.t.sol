...
contract DepositWETHHookTest is Helpers {
    using BytesLib for bytes;

    DepositWETHHook public hook;
    ...
    function test_DepositWETH_ReplaceCalldataAmounts_ThenBuild() public view {
        bytes memory data = _encodeData(false);
    ...
    function test_DepositWETH_ReplaceCalldataAmounts_PreservesOtherFields() public view {
        bytes memory data = _encodeData(false);
