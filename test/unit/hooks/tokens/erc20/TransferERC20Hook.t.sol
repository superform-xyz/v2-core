...
contract TransferERC20HookTest is Helpers {
    ...
    function test_TransferERC20_ReplaceCalldataAmount_ThenBuild() public view {
        bytes memory data = _encodeData(false);
    ...
    function test_TransferERC20_ReplaceCalldataAmount_PreservesOtherFields() public view {
        bytes memory data = _encodeData(false);
