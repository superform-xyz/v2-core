...
contract NativeTransferHookTest is Helpers {
    ...
    function test_NativeTransfer_ReplaceCalldataAmount_ThenBuild() public view {
        bytes memory data = _encodeData();
    ...
    function test_NativeTransfer_ReplaceCalldataAmount_PreservesOtherFields() public view {
        bytes memory data = _encodeData();
