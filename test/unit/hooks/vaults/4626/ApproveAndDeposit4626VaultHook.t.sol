...
contract ApproveAndDeposit4626VaultHookTest is Helpers {
    ...
    function setUp() public {
        ...
        hook = new ApproveAndDeposit4626VaultHook();
    }
    ...
    function _encodeData(bool usePrevHook) internal view returns (bytes memory) {
        return abi.encodePacked(yieldSourceOracleId, yieldSource, token, amount, usePrevHook, address(0), uint256(0));
    }
}
