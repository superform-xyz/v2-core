...
contract WithdrawVestedRFLRHookV2Test is Helpers {
    WithdrawVestedRFLRHookV2 public hook;
    ...
    function setUp() public {
        ...
        hook = new WithdrawVestedRFLRHookV2(rNat, wflr);
    }
    ...
    function test_Constructor_RevertIf_RNatZero() public {
        ...
        new WithdrawVestedRFLRHookV2(address(0), wflr);
    }

    function test_Constructor_RevertIf_WFLRZero() public {
        vm.expectRevert(BaseHook.ADDRESS_NOT_VALID.selector);
        new WithdrawVestedRFLRHookV2(rNat, address(0));
    }

    function test_Constructor_RevertIf_BothZero() public {
        vm.expectRevert(BaseHook.ADDRESS_NOT_VALID.selector);
        new WithdrawVestedRFLRHookV2(address(0), address(0));
    }
    ...
    function test_Build_RevertIf_NothingVested_ZeroBalance() public {
        ...
        vm.expectRevert(WithdrawVestedRFLRHookV2.NOTHING_TO_WITHDRAW.selector);
    ...
    function test_PostExecute_MinOut_Exceeded_Reverts() public {
        ...
        vm.expectRevert(WithdrawVestedRFLRHookV2.SLIPPAGE_EXCEEDED.selector);
        vm.prank(account);
        hook.postExecute(address(0), account, data);
    }
