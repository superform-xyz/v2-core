...
/// @title RecordRedemptionPendlePTAmortizedOracleHookTest
/// @notice Unit tests for RecordRedemptionPendlePTAmortizedOracleHook
contract RecordRedemptionPendlePTAmortizedOracleHookTest is Test {
    RecordRedemptionPendlePTAmortizedOracleHook public hook;
    ...
    function setUp() public {
        ...
        hook = new RecordRedemptionPendlePTAmortizedOracleHook(address(oracle));
    }
    ...
    function test_Constructor_RevertsOnZeroAddress() public {
        ...
        new RecordRedemptionPendlePTAmortizedOracleHook(address(0));
    }
    ...
    function test_Build_RevertsOnZeroMarket() public {
        ...
        vm.expectRevert(RecordRedemptionPendlePTAmortizedOracleHook.MARKET_NOT_VALID.selector);
    ...
    function test_Build_RevertsOnZeroPtSold() public {
        ...
        vm.expectRevert(RecordRedemptionPendlePTAmortizedOracleHook.PT_SOLD_NOT_VALID.selector);
        hook.build(address(0), account, data);
    }
    ...
    function _encodeData(address _market, uint256 _ptSold, bool _usePrevHookAmount) internal pure returns (bytes memory) {
        return abi.encodePacked(bytes(new bytes(52)), _market, _ptSold, _usePrevHookAmount);
    }
}
