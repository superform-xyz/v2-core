...
contract PendleRouterSwapHookTest is Helpers {
    ...
    function test_Build_SwapExactTokenForPt() public view {
        ...
        bytes memory data = abi.encodePacked(bytes32(bytes("")), market, bytes1(uint8(0)), abi.encode(uint256(0), txData));
    ...
    function test_UsePrevHookAmount_SetToTrue() public view {
        ...
        bytes memory data = abi.encodePacked(bytes32(bytes("")), market, bytes1(uint8(1)), abi.encode(uint256(0), txData));
    ...
    function test_Build_RevertIf_InvalidSwapType() public {
        ...
        bytes memory data =
            abi.encodePacked(bytes32(bytes("")), market, bytes1(uint8(0)), abi.encode(uint256(0), invalidTxData));
    ...
    function test_DecodeTokenOutAndReceiver_RevertIf_InvalidSwapType() public {
        ...
        bytes memory data = abi.encodePacked(
            ...
            abi.encode(uint256(0), invalidTxData) // payload
        );
