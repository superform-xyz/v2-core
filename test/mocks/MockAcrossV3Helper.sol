...
import { IAcrossSpokePoolV3 } from "./IAcrossSpokePoolV3.sol";
import { IERC20 } from "openzeppelin-contracts/contracts/token/ERC20/IERC20.sol";

/// @title AcrossV3 Helper
/// @notice helps simulate AcrossV3 message relaying
contract MockAcrossV3Helper is Test {
        ...
        for (uint256 i; i < args.logs.length; i++) {
            ...
            if (
                ...
                if (vars.destinationChainId == args.destinationChainId) {
                    ...
                    // 680_000 gas is big enough to make fillV3Relay() succeedbut it is not enough to call the account’s executeFromExecutor (before contract updates)
                    IAcrossSpokePoolV3(args.destinationSpokePool).fillV3Relay{ gas: 680_000 }(
