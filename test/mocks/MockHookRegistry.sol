...
// --- Yearn
// import { YearnStakeHook } from "../../src/core/hooks/stake/yearn/YearnStakeHook.sol";
...
contract MockHookRegistry is BaseTest {
    ...
    function _deployAdditionalHooks() internal {
        for (uint256 i = 0; i < chainIds.length; ++i) {
            ...
            A.approveWithPermit2Hook = new ApproveWithPermit2Hook(
            ...
            hooks[chainIds[i]]["ApproveWithPermit2Hook"] = Hook(
            ...
            A.permitWithPermit2Hook = new PermitWithPermit2Hook(
                address(A.superRegistry), address(this), 0x000000000022D473030F116dDEE9F6B43aC78BA3
            );
            ...
            hooks[chainIds[i]]["PermitWithPermit2Hook"] = Hook(
            ...
            hooks[chainIds[i]]["Deposit7540VaultHook"] = Hook(
            ...
            hooks[chainIds[i]]["Withdraw7540VaultHook"] = Hook(
            ...
            A.swap1InchClipperRouterHook = new Swap1InchClipperRouterHook(
                address(A.superRegistry), address(this), 0x111111125421cA6dc452d289314280a0f8842A65
            );
            ...
            hooks[chainIds[i]]["Swap1InchClipperRouterHook"] = Hook(
            ...
            A.swap1InchGenericRouterHook = new Swap1InchGenericRouterHook(
                address(A.superRegistry), address(this), 0x111111125421cA6dc452d289314280a0f8842A65
            );
            ...
            hooks[chainIds[i]]["Swap1InchGenericRouterHook"] = Hook(
            ...
            A.swap1InchUnoswapHook = new Swap1InchUnoswapHook(
                address(A.superRegistry), address(this), 0x111111125421cA6dc452d289314280a0f8842A65
            );
            ...
            hooks[chainIds[i]]["Swap1InchUnoswapHook"] = Hook(
            ...
            hooks[chainIds[i]]["GearboxStakeHook"] = Hook(
                "GearboxStakeHook", HookCategory.Stakes, HookCategory.VaultDeposits, address(A.gearboxStakeHook), ""
            );
            ...
            hooks[chainIds[i]]["GearboxWithdrawHook"] = Hook(
                "GearboxWithdrawHook", HookCategory.Claims, HookCategory.Stakes, address(A.gearboxWithdrawHook), ""
            );
            ...
            hooks[chainIds[i]]["SomelierStakeHook"] = Hook(
                "SomelierStakeHook", HookCategory.Stakes, HookCategory.VaultDeposits, address(A.somelierStakeHook), ""
            );
            ...
            hooks[chainIds[i]]["SomelierUnbondAllHook"] = Hook(
                "SomelierUnbondAllHook", HookCategory.Claims, HookCategory.Stakes, address(A.somelierUnbondAllHook), ""
            );
            ...
            hooks[chainIds[i]]["SomelierUnbondHook"] =
                Hook("SomelierUnbondHook", HookCategory.Claims, HookCategory.Stakes, address(A.somelierUnbondHook), "");
            ...
            hooks[chainIds[i]]["SomelierUnstakeAllHook"] = Hook(
            ...
            hooks[chainIds[i]]["YearnClaimOneRewardHook"] = Hook(
            ...
            hooks[chainIds[i]]["YearnClaimAllRewardsHook"] = Hook(
