...
import { ApproveAndAcrossSendFundsAndExecuteOnDstHook } from "../src/hooks/bridges/across/ApproveAndAcrossSendFundsAndExecuteOnDstHook.sol";
...
struct Addresses {
    ...
    MorphoSupplyAndBorrowHook MorphoSupplyAndBorrowHook;
    ...
    SpectraExchangeDepositHook spectraExchangeDepositHook;
    SpectraExchangeRedeemHook spectraExchangeRedeemHook;
...
contract BaseTest is Helpers, RhinestoneModuleKit, SignatureHelper, MerkleTreeHelper, OdosAPIParser, InternalHelpers {
    ...
    function _deployHooks(Addresses[] memory A) internal returns (Addresses[] memory) {
        ...
        for (uint256 i = 0; i < chainIds.length; ++i) {
            ...
            A[i].approveAndAcrossSendFundsAndExecuteOnDstHook = new ApproveAndAcrossSendFundsAndExecuteOnDstHook{ salt: SALT }(
                SPOKE_POOL_V3_ADDRESSES[chainIds[i]], _getContract(chainIds[i], SUPER_MERKLE_VALIDATOR_KEY)
            );
            ...
            hooksAddresses[40] = address(A[i].deBridgeCancelOrderHook);
            ...
            hooksAddresses[40] = address(A[i].fluidClaimRewardHook);
            ...
            hooksAddresses[40] = address(A[i].fluidStakeHook);
            ...
            hooksAddresses[40] = address(A[i].approveAndFluidStakeHook);
            ...
            hooksAddresses[40] = address(A[i].fluidUnstakeHook);
            ...
            hooksAddresses[40] = address(A[i].gearboxClaimRewardHook);
            ...
            hooksAddresses[40] = address(A[i].gearboxStakeHook);
            ...
            hooksAddresses[40] = address(A[i].approveAndGearboxStakeHook);
            ...
            hooksAddresses[40] = address(A[i].gearboxUnstakeHook);
            ...
            hooksAddresses[40] = address(A[i].yearnClaimOneRewardHook);
            ...
            hooksAddresses[40] = address(A[i].batchTransferFromHook);
            ...
            hooksAddresses[40] = address(A[i].ethenaCooldownSharesHook);
            ...
            hooksAddresses[40] = address(A[i].ethenaUnstakeHook);
            ...
            hooksAddresses[40] = address(A[i].spectraExchangeDepositHook);
            ...
            hooksAddresses[40] = address(A[i].spectraExchangeRedeemHook);
            ...
            hooksAddresses[40] = address(A[i].pendleRouterSwapHook);
            ...
            hooksAddresses[40] = address(A[i].pendleRouterRedeemHook);
            ...
            hooksAddresses[40] = address(A[i].cancelDepositRequest7540Hook);
            ...
            hooksAddresses[40] = address(A[i].claimCancelDepositRequest7540Hook);
            ...
            hooks[chainIds[i]][MORPHO_BORROW_HOOK_KEY] = Hook(
                ...
                HookCategory.Loans,
                HookCategory.None,
                address(A[i].MorphoSupplyAndBorrowHook),
                ""
            );
