...
//        superLedger = ISuperLedger(_getContract(ETH, SUPER_LEDGER_OPTIMIZED_AVG_KEY));
...
//    }
//
//    function test_DepositAndSuperLedgerEntries_OptimizedAVG() external {
...
//    }
//
//    function test_MultipleDepositsAndPartialWithdrawal_Fees_OptimizedAVG() external {
//        uint256 amount = SMALL;
...
//    }
//
//    function test_MultipleDepositsAndFullWithdrawal_ForMultipleEntries_Fees_OptimizedAVG() external {
//        uint256 amount = SMALL;
//        _getTokens(underlying, account, amount * 2);
//
//        // make sure custom pps is 1
...
//    }
//
//    function test_MultipleDepositsAndFullWithdrawal_ForSingleEntries_Fees_OptimizedAVG() external {
//        uint256 amount = SMALL;
//        _getTokens(underlying, account, amount);
//
//        // make sure custom pps is 1
