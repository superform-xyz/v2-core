...
contract SuperVaultFulfillRedeemRequestsTest is SuperVaultFulfillDepositRequestsTest {
    ...
    function test_ClaimRedeem_AfterPriceIncrease() public {
        ...
        assertApproxEqRel(assetsReceived, redeemAmount, 0.01e18, "Assets received should be greater than or equal to requested redeem amount");
        
        uint256 strategyAssetBalanceAfter = asset.balanceOf(address(strategy));
        assertApproxEqRel(strategyAssetBalanceBefore - strategyAssetBalanceAfter, assetsReceived, 0.01e18, "Strategy asset balance should decrease by the amount sent to user");
    ...
    function test_Redeem_RoundingBehavior() public {
        ...
        console2.log("Requested redeem amount:", redeemAmount);
        console2.log("Difference:", redeemAmount > assetsReceived ? 
    ...
    function test_RequestRedeem_VerifyAmounts() public {
        ...
        vars.userShareBalances = new uint256[](RANDOM_ACCOUNT_COUNT);
        for (uint256 i; i < RANDOM_ACCOUNT_COUNT; i++) {
        ...
        vars.totalDepositAmount = vars.depositAmount * RANDOM_ACCOUNT_COUNT;
        vars.totalRedeemAmount = vars.redeemAmount * RANDOM_ACCOUNT_COUNT;
    ...
    function test_MultipleUsers_SameAllocation_EqualRedeemValue() public {
        ...
        uint256 totalRedeemAmount = redeemAmount * RANDOM_ACCOUNT_COUNT;
        ...
        uint256[] memory assetsReceived = new uint256[](RANDOM_ACCOUNT_COUNT);
        uint256[] memory sharesBurned = new uint256[](RANDOM_ACCOUNT_COUNT);
        ...
        for (uint256 i = 1; i < RANDOM_ACCOUNT_COUNT; i++) {
    ...
    function test_MultipleUsers_ChangingAllocation_RedeemValue() public {
        ...
        for (uint256 i = 0; i < RANDOM_ACCOUNT_COUNT; i++) {
