...
func (_SuperMerkleValidator *SuperMerkleValidatorCaller) VALIDSIGNATURE(opts *bind.CallOpts) ([4]byte, error) {
	var out []interface{}
	err := _SuperMerkleValidator.contract.Call(opts, &out, "VALID_SIGNATURE")
...
//
// Solidity: function VALID_SIGNATURE() view returns(bytes4)
func (_SuperMerkleValidator *SuperMerkleValidatorSession) VALIDSIGNATURE() ([4]byte, error) {
	return _SuperMerkleValidator.Contract.VALIDSIGNATURE(&_SuperMerkleValidator.CallOpts)
}

// VALIDSIGNATURE is a free data retrieval call binding the contract method 0x8ee749ca.
//
// Solidity: function VALID_SIGNATURE() view returns(bytes4)
func (_SuperMerkleValidator *SuperMerkleValidatorCallerSession) VALIDSIGNATURE() ([4]byte, error) {
	return _SuperMerkleValidator.Contract.VALIDSIGNATURE(&_SuperMerkleValidator.CallOpts)
}
