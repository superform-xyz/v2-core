...
// PreviewOutflowWithoutFees is a free data retrieval call binding the contract method 0x2c425c39.
//
// Solidity: function previewOutflowWithoutFees(bytes4 yieldSourceOracleId, address yieldSourceAddress, address , address user, uint256 usedShares, uint256 feePercent) view returns(uint256)
func (_SuperLedger *SuperLedgerCaller) PreviewOutflowWithoutFees(opts *bind.CallOpts, yieldSourceOracleId [4]byte, yieldSourceAddress common.Address, arg2 common.Address, user common.Address, usedShares *big.Int, feePercent *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _SuperLedger.contract.Call(opts, &out, "previewOutflowWithoutFees", yieldSourceOracleId, yieldSourceAddress, arg2, user, usedShares, feePercent)
...
//
// Solidity: function previewOutflowWithoutFees(bytes4 yieldSourceOracleId, address yieldSourceAddress, address , address user, uint256 usedShares, uint256 feePercent) view returns(uint256)
func (_SuperLedger *SuperLedgerSession) PreviewOutflowWithoutFees(yieldSourceOracleId [4]byte, yieldSourceAddress common.Address, arg2 common.Address, user common.Address, usedShares *big.Int, feePercent *big.Int) (*big.Int, error) {
	return _SuperLedger.Contract.PreviewOutflowWithoutFees(&_SuperLedger.CallOpts, yieldSourceOracleId, yieldSourceAddress, arg2, user, usedShares, feePercent)
}

// PreviewOutflowWithoutFees is a free data retrieval call binding the contract method 0x2c425c39.
//
// Solidity: function previewOutflowWithoutFees(bytes4 yieldSourceOracleId, address yieldSourceAddress, address , address user, uint256 usedShares, uint256 feePercent) view returns(uint256)
func (_SuperLedger *SuperLedgerCallerSession) PreviewOutflowWithoutFees(yieldSourceOracleId [4]byte, yieldSourceAddress common.Address, arg2 common.Address, user common.Address, usedShares *big.Int, feePercent *big.Int) (*big.Int, error) {
	return _SuperLedger.Contract.PreviewOutflowWithoutFees(&_SuperLedger.CallOpts, yieldSourceOracleId, yieldSourceAddress, arg2, user, usedShares, feePercent)
}
