...
func (_AbstractYieldSourceOracle *AbstractYieldSourceOracleCaller) SUPERLEDGERCONFIGURATION(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _AbstractYieldSourceOracle.contract.Call(opts, &out, "SUPER_LEDGER_CONFIGURATION")
...
func (_AbstractYieldSourceOracle *AbstractYieldSourceOracleCaller) GetAssetOutputWithFees(opts *bind.CallOpts, yieldSourceOracleId [32]byte, yieldSourceAddress common.Address, assetOut common.Address, user common.Address, usedShares *big.Int) (*big.Int, error) {
	var out []interface{}
...
//
// Solidity: function getAssetOutputWithFees(bytes32 yieldSourceOracleId, address yieldSourceAddress, address assetOut, address user, uint256 usedShares) view returns(uint256)
func (_AbstractYieldSourceOracle *AbstractYieldSourceOracleSession) GetAssetOutputWithFees(yieldSourceOracleId [32]byte, yieldSourceAddress common.Address, assetOut common.Address, user common.Address, usedShares *big.Int) (*big.Int, error) {
...
//
// Solidity: function getAssetOutputWithFees(bytes32 yieldSourceOracleId, address yieldSourceAddress, address assetOut, address user, uint256 usedShares) view returns(uint256)
func (_AbstractYieldSourceOracle *AbstractYieldSourceOracleCallerSession) GetAssetOutputWithFees(yieldSourceOracleId [32]byte, yieldSourceAddress common.Address, assetOut common.Address, user common.Address, usedShares *big.Int) (*big.Int, error) {
	return _AbstractYieldSourceOracle.Contract.GetAssetOutputWithFees(&_AbstractYieldSourceOracle.CallOpts, yieldSourceOracleId, yieldSourceAddress, assetOut, user, usedShares)
}
...
//
// Solidity: function getWithdrawalShareOutput(address yieldSourceAddress, address assetIn, uint256 assetsIn) view returns(uint256)
func (_AbstractYieldSourceOracle *AbstractYieldSourceOracleCaller) GetWithdrawalShareOutput(opts *bind.CallOpts, yieldSourceAddress common.Address, assetIn common.Address, assetsIn *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _AbstractYieldSourceOracle.contract.Call(opts, &out, "getWithdrawalShareOutput", yieldSourceAddress, assetIn, assetsIn)
...
//
// Solidity: function getWithdrawalShareOutput(address yieldSourceAddress, address assetIn, uint256 assetsIn) view returns(uint256)
func (_AbstractYieldSourceOracle *AbstractYieldSourceOracleSession) GetWithdrawalShareOutput(yieldSourceAddress common.Address, assetIn common.Address, assetsIn *big.Int) (*big.Int, error) {
	return _AbstractYieldSourceOracle.Contract.GetWithdrawalShareOutput(&_AbstractYieldSourceOracle.CallOpts, yieldSourceAddress, assetIn, assetsIn)
}

// GetWithdrawalShareOutput is a free data retrieval call binding the contract method 0x7eeb8107.
//
// Solidity: function getWithdrawalShareOutput(address yieldSourceAddress, address assetIn, uint256 assetsIn) view returns(uint256)
func (_AbstractYieldSourceOracle *AbstractYieldSourceOracleCallerSession) GetWithdrawalShareOutput(yieldSourceAddress common.Address, assetIn common.Address, assetsIn *big.Int) (*big.Int, error) {
	return _AbstractYieldSourceOracle.Contract.GetWithdrawalShareOutput(&_AbstractYieldSourceOracle.CallOpts, yieldSourceAddress, assetIn, assetsIn)
}
