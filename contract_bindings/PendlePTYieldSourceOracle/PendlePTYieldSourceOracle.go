...
func (_PendlePTYieldSourceOracle *PendlePTYieldSourceOracleCaller) Decimals(opts *bind.CallOpts, market common.Address) (uint8, error) {
	var out []interface{}
	err := _PendlePTYieldSourceOracle.contract.Call(opts, &out, "decimals", market)
...
//
// Solidity: function decimals(address market) view returns(uint8)
func (_PendlePTYieldSourceOracle *PendlePTYieldSourceOracleSession) Decimals(market common.Address) (uint8, error) {
	return _PendlePTYieldSourceOracle.Contract.Decimals(&_PendlePTYieldSourceOracle.CallOpts, market)
}

// Decimals is a free data retrieval call binding the contract method 0xd449a832.
//
// Solidity: function decimals(address market) view returns(uint8)
func (_PendlePTYieldSourceOracle *PendlePTYieldSourceOracleCallerSession) Decimals(market common.Address) (uint8, error) {
	return _PendlePTYieldSourceOracle.Contract.Decimals(&_PendlePTYieldSourceOracle.CallOpts, market)
}
