...
func (_PendlePTYieldSourceOracle *PendlePTYieldSourceOracleCaller) SUPERLEDGERCONFIGURATION(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _PendlePTYieldSourceOracle.contract.Call(opts, &out, "SUPER_LEDGER_CONFIGURATION")
...
//
// Solidity: function SUPER_LEDGER_CONFIGURATION() view returns(address)
func (_PendlePTYieldSourceOracle *PendlePTYieldSourceOracleSession) SUPERLEDGERCONFIGURATION() (common.Address, error) {
	return _PendlePTYieldSourceOracle.Contract.SUPERLEDGERCONFIGURATION(&_PendlePTYieldSourceOracle.CallOpts)
}

// SUPERLEDGERCONFIGURATION is a free data retrieval call binding the contract method 0x8717164a.
//
// Solidity: function SUPER_LEDGER_CONFIGURATION() view returns(address)
func (_PendlePTYieldSourceOracle *PendlePTYieldSourceOracleCallerSession) SUPERLEDGERCONFIGURATION() (common.Address, error) {
	return _PendlePTYieldSourceOracle.Contract.SUPERLEDGERCONFIGURATION(&_PendlePTYieldSourceOracle.CallOpts)
}
...
func (_PendlePTYieldSourceOracle *PendlePTYieldSourceOracleCaller) GetAssetOutputWithFees(opts *bind.CallOpts, yieldSourceOracleId [32]byte, yieldSourceAddress common.Address, assetOut common.Address, user common.Address, usedShares *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _PendlePTYieldSourceOracle.contract.Call(opts, &out, "getAssetOutputWithFees", yieldSourceOracleId, yieldSourceAddress, assetOut, user, usedShares)
...
//
// Solidity: function getAssetOutputWithFees(bytes32 yieldSourceOracleId, address yieldSourceAddress, address assetOut, address user, uint256 usedShares) view returns(uint256)
func (_PendlePTYieldSourceOracle *PendlePTYieldSourceOracleSession) GetAssetOutputWithFees(yieldSourceOracleId [32]byte, yieldSourceAddress common.Address, assetOut common.Address, user common.Address, usedShares *big.Int) (*big.Int, error) {
	return _PendlePTYieldSourceOracle.Contract.GetAssetOutputWithFees(&_PendlePTYieldSourceOracle.CallOpts, yieldSourceOracleId, yieldSourceAddress, assetOut, user, usedShares)
}

// GetAssetOutputWithFees is a free data retrieval call binding the contract method 0x2f112c46.
//
// Solidity: function getAssetOutputWithFees(bytes32 yieldSourceOracleId, address yieldSourceAddress, address assetOut, address user, uint256 usedShares) view returns(uint256)
func (_PendlePTYieldSourceOracle *PendlePTYieldSourceOracleCallerSession) GetAssetOutputWithFees(yieldSourceOracleId [32]byte, yieldSourceAddress common.Address, assetOut common.Address, user common.Address, usedShares *big.Int) (*big.Int, error) {
	return _PendlePTYieldSourceOracle.Contract.GetAssetOutputWithFees(&_PendlePTYieldSourceOracle.CallOpts, yieldSourceOracleId, yieldSourceAddress, assetOut, user, usedShares)
}
...
func (_PendlePTYieldSourceOracle *PendlePTYieldSourceOracleCaller) GetWithdrawalShareOutput(opts *bind.CallOpts, market common.Address, arg1 common.Address, assetsIn *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _PendlePTYieldSourceOracle.contract.Call(opts, &out, "getWithdrawalShareOutput", market, arg1, assetsIn)
...
//
// Solidity: function getWithdrawalShareOutput(address market, address , uint256 assetsIn) view returns(uint256)
func (_PendlePTYieldSourceOracle *PendlePTYieldSourceOracleSession) GetWithdrawalShareOutput(market common.Address, arg1 common.Address, assetsIn *big.Int) (*big.Int, error) {
	return _PendlePTYieldSourceOracle.Contract.GetWithdrawalShareOutput(&_PendlePTYieldSourceOracle.CallOpts, market, arg1, assetsIn)
}

// GetWithdrawalShareOutput is a free data retrieval call binding the contract method 0x7eeb8107.
//
// Solidity: function getWithdrawalShareOutput(address market, address , uint256 assetsIn) view returns(uint256)
func (_PendlePTYieldSourceOracle *PendlePTYieldSourceOracleCallerSession) GetWithdrawalShareOutput(market common.Address, arg1 common.Address, assetsIn *big.Int) (*big.Int, error) {
	return _PendlePTYieldSourceOracle.Contract.GetWithdrawalShareOutput(&_PendlePTYieldSourceOracle.CallOpts, market, arg1, assetsIn)
}
