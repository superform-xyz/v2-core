...
func (_ERC5115YieldSourceOracle *ERC5115YieldSourceOracleCaller) GetAssetOutput(opts *bind.CallOpts, yieldSourceAddress common.Address, assetIn common.Address, sharesIn *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _ERC5115YieldSourceOracle.contract.Call(opts, &out, "getAssetOutput", yieldSourceAddress, assetIn, sharesIn)
...
//
// Solidity: function getAssetOutput(address yieldSourceAddress, address assetIn, uint256 sharesIn) view returns(uint256)
func (_ERC5115YieldSourceOracle *ERC5115YieldSourceOracleSession) GetAssetOutput(yieldSourceAddress common.Address, assetIn common.Address, sharesIn *big.Int) (*big.Int, error) {
	return _ERC5115YieldSourceOracle.Contract.GetAssetOutput(&_ERC5115YieldSourceOracle.CallOpts, yieldSourceAddress, assetIn, sharesIn)
}

// GetAssetOutput is a free data retrieval call binding the contract method 0xaa5815fd.
//
// Solidity: function getAssetOutput(address yieldSourceAddress, address assetIn, uint256 sharesIn) view returns(uint256)
func (_ERC5115YieldSourceOracle *ERC5115YieldSourceOracleCallerSession) GetAssetOutput(yieldSourceAddress common.Address, assetIn common.Address, sharesIn *big.Int) (*big.Int, error) {
	return _ERC5115YieldSourceOracle.Contract.GetAssetOutput(&_ERC5115YieldSourceOracle.CallOpts, yieldSourceAddress, assetIn, sharesIn)
}
...
func (_ERC5115YieldSourceOracle *ERC5115YieldSourceOracleCaller) IsValidUnderlyingAsset(opts *bind.CallOpts, yieldSourceAddress common.Address, expectedUnderlying common.Address) (bool, error) {
	var out []interface{}
	err := _ERC5115YieldSourceOracle.contract.Call(opts, &out, "isValidUnderlyingAsset", yieldSourceAddress, expectedUnderlying)
...
//
// Solidity: function isValidUnderlyingAsset(address yieldSourceAddress, address expectedUnderlying) view returns(bool)
func (_ERC5115YieldSourceOracle *ERC5115YieldSourceOracleSession) IsValidUnderlyingAsset(yieldSourceAddress common.Address, expectedUnderlying common.Address) (bool, error) {
	return _ERC5115YieldSourceOracle.Contract.IsValidUnderlyingAsset(&_ERC5115YieldSourceOracle.CallOpts, yieldSourceAddress, expectedUnderlying)
}

// IsValidUnderlyingAsset is a free data retrieval call binding the contract method 0x6e7f28b2.
//
// Solidity: function isValidUnderlyingAsset(address yieldSourceAddress, address expectedUnderlying) view returns(bool)
func (_ERC5115YieldSourceOracle *ERC5115YieldSourceOracleCallerSession) IsValidUnderlyingAsset(yieldSourceAddress common.Address, expectedUnderlying common.Address) (bool, error) {
	return _ERC5115YieldSourceOracle.Contract.IsValidUnderlyingAsset(&_ERC5115YieldSourceOracle.CallOpts, yieldSourceAddress, expectedUnderlying)
}
...
func (_ERC5115YieldSourceOracle *ERC5115YieldSourceOracleCaller) IsValidUnderlyingAssets(opts *bind.CallOpts, yieldSourceAddresses []common.Address, expectedUnderlying []common.Address) ([]bool, error) {
	var out []interface{}
	err := _ERC5115YieldSourceOracle.contract.Call(opts, &out, "isValidUnderlyingAssets", yieldSourceAddresses, expectedUnderlying)
...
//
// Solidity: function isValidUnderlyingAssets(address[] yieldSourceAddresses, address[] expectedUnderlying) view returns(bool[] isValid)
func (_ERC5115YieldSourceOracle *ERC5115YieldSourceOracleSession) IsValidUnderlyingAssets(yieldSourceAddresses []common.Address, expectedUnderlying []common.Address) ([]bool, error) {
	return _ERC5115YieldSourceOracle.Contract.IsValidUnderlyingAssets(&_ERC5115YieldSourceOracle.CallOpts, yieldSourceAddresses, expectedUnderlying)
}

// IsValidUnderlyingAssets is a free data retrieval call binding the contract method 0xb25736fc.
//
// Solidity: function isValidUnderlyingAssets(address[] yieldSourceAddresses, address[] expectedUnderlying) view returns(bool[] isValid)
func (_ERC5115YieldSourceOracle *ERC5115YieldSourceOracleCallerSession) IsValidUnderlyingAssets(yieldSourceAddresses []common.Address, expectedUnderlying []common.Address) ([]bool, error) {
	return _ERC5115YieldSourceOracle.Contract.IsValidUnderlyingAssets(&_ERC5115YieldSourceOracle.CallOpts, yieldSourceAddresses, expectedUnderlying)
}
