...
//
// Solidity: function getSuperVaultState(address controller) view returns((uint256,uint256,uint256,uint256,uint256,uint256) state)
...
// HandleOperation is a paid mutator transaction binding the contract method 0xbe717a06.
//
// Solidity: function handleOperation(address controller, address receiver, uint256 assets, uint256 shares, uint8 operation) returns()
func (_SuperVaultStrategy *SuperVaultStrategyTransactor) HandleOperation(opts *bind.TransactOpts, controller common.Address, receiver common.Address, assets *big.Int, shares *big.Int, operation uint8) (*types.Transaction, error) {
	return _SuperVaultStrategy.contract.Transact(opts, "handleOperation", controller, receiver, assets, shares, operation)
}

// HandleOperation is a paid mutator transaction binding the contract method 0xbe717a06.
//
// Solidity: function handleOperation(address controller, address receiver, uint256 assets, uint256 shares, uint8 operation) returns()
func (_SuperVaultStrategy *SuperVaultStrategySession) HandleOperation(controller common.Address, receiver common.Address, assets *big.Int, shares *big.Int, operation uint8) (*types.Transaction, error) {
	return _SuperVaultStrategy.Contract.HandleOperation(&_SuperVaultStrategy.TransactOpts, controller, receiver, assets, shares, operation)
}

// HandleOperation is a paid mutator transaction binding the contract method 0xbe717a06.
//
// Solidity: function handleOperation(address controller, address receiver, uint256 assets, uint256 shares, uint8 operation) returns()
func (_SuperVaultStrategy *SuperVaultStrategyTransactorSession) HandleOperation(controller common.Address, receiver common.Address, assets *big.Int, shares *big.Int, operation uint8) (*types.Transaction, error) {
	return _SuperVaultStrategy.Contract.HandleOperation(&_SuperVaultStrategy.TransactOpts, controller, receiver, assets, shares, operation)
}
...
// UpdateSuperVaultState is a paid mutator transaction binding the contract method 0x53c71a6b.
//
// Solidity: function updateSuperVaultState(address controller, (uint256,uint256,uint256,uint256,uint256,uint256) state) returns()
func (_SuperVaultStrategy *SuperVaultStrategyTransactor) UpdateSuperVaultState(opts *bind.TransactOpts, controller common.Address, state ISuperVaultStrategySuperVaultState) (*types.Transaction, error) {
	return _SuperVaultStrategy.contract.Transact(opts, "updateSuperVaultState", controller, state)
}

// UpdateSuperVaultState is a paid mutator transaction binding the contract method 0x53c71a6b.
//
// Solidity: function updateSuperVaultState(address controller, (uint256,uint256,uint256,uint256,uint256,uint256) state) returns()
func (_SuperVaultStrategy *SuperVaultStrategySession) UpdateSuperVaultState(controller common.Address, state ISuperVaultStrategySuperVaultState) (*types.Transaction, error) {
	return _SuperVaultStrategy.Contract.UpdateSuperVaultState(&_SuperVaultStrategy.TransactOpts, controller, state)
}

// UpdateSuperVaultState is a paid mutator transaction binding the contract method 0x53c71a6b.
//
// Solidity: function updateSuperVaultState(address controller, (uint256,uint256,uint256,uint256,uint256,uint256) state) returns()
func (_SuperVaultStrategy *SuperVaultStrategyTransactorSession) UpdateSuperVaultState(controller common.Address, state ISuperVaultStrategySuperVaultState) (*types.Transaction, error) {
	return _SuperVaultStrategy.Contract.UpdateSuperVaultState(&_SuperVaultStrategy.TransactOpts, controller, state)
}
