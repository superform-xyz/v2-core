...
func (_SuperDestinationExecutor *SuperDestinationExecutorCaller) LEDGERCONFIGURATION(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _SuperDestinationExecutor.contract.Call(opts, &out, "LEDGER_CONFIGURATION")
...
func (_SuperDestinationExecutor *SuperDestinationExecutorTransactor) MarkRootsAsUsed(opts *bind.TransactOpts, roots [][32]byte) (*types.Transaction, error) {
	return _SuperDestinationExecutor.contract.Transact(opts, "markRootsAsUsed", roots)
}

// MarkRootsAsUsed is a paid mutator transaction binding the contract method 0xa5c08d3d.
//
// Solidity: function markRootsAsUsed(bytes32[] roots) returns()
func (_SuperDestinationExecutor *SuperDestinationExecutorSession) MarkRootsAsUsed(roots [][32]byte) (*types.Transaction, error) {
	return _SuperDestinationExecutor.Contract.MarkRootsAsUsed(&_SuperDestinationExecutor.TransactOpts, roots)
}

// MarkRootsAsUsed is a paid mutator transaction binding the contract method 0xa5c08d3d.
//
// Solidity: function markRootsAsUsed(bytes32[] roots) returns()
func (_SuperDestinationExecutor *SuperDestinationExecutorTransactorSession) MarkRootsAsUsed(roots [][32]byte) (*types.Transaction, error) {
	return _SuperDestinationExecutor.Contract.MarkRootsAsUsed(&_SuperDestinationExecutor.TransactOpts, roots)
}
...
// SuperDestinationExecutorSuperDestinationExecutorMarkRootsAsUsedIterator is returned from FilterSuperDestinationExecutorMarkRootsAsUsed and is used to iterate over the raw logs and unpacked data for SuperDestinationExecutorMarkRootsAsUsed events raised by the SuperDestinationExecutor contract.
type SuperDestinationExecutorSuperDestinationExecutorMarkRootsAsUsedIterator struct {
	Event *SuperDestinationExecutorSuperDestinationExecutorMarkRootsAsUsed // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *SuperDestinationExecutorSuperDestinationExecutorMarkRootsAsUsedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(SuperDestinationExecutorSuperDestinationExecutorMarkRootsAsUsed)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *SuperDestinationExecutorSuperDestinationExecutorMarkRootsAsUsedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *SuperDestinationExecutorSuperDestinationExecutorMarkRootsAsUsedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// SuperDestinationExecutorSuperDestinationExecutorMarkRootsAsUsed represents a SuperDestinationExecutorMarkRootsAsUsed event raised by the SuperDestinationExecutor contract.
type SuperDestinationExecutorSuperDestinationExecutorMarkRootsAsUsed struct {
	Account common.Address
	Roots   [][32]byte
	Raw     types.Log // Blockchain specific contextual infos
}
...
func (_SuperDestinationExecutor *SuperDestinationExecutorFilterer) FilterSuperDestinationExecutorMarkRootsAsUsed(opts *bind.FilterOpts, account []common.Address) (*SuperDestinationExecutorSuperDestinationExecutorMarkRootsAsUsedIterator, error) {
	...
	logs, sub, err := _SuperDestinationExecutor.contract.FilterLogs(opts, "SuperDestinationExecutorMarkRootsAsUsed", accountRule)
	if err != nil {
		return nil, err
	}
	return &SuperDestinationExecutorSuperDestinationExecutorMarkRootsAsUsedIterator{contract: _SuperDestinationExecutor.contract, event: "SuperDestinationExecutorMarkRootsAsUsed", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event SuperDestinationExecutorMarkRootsAsUsed(address indexed account, bytes32[] roots)
func (_SuperDestinationExecutor *SuperDestinationExecutorFilterer) WatchSuperDestinationExecutorMarkRootsAsUsed(opts *bind.WatchOpts, sink chan<- *SuperDestinationExecutorSuperDestinationExecutorMarkRootsAsUsed, account []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _SuperDestinationExecutor.contract.WatchLogs(opts, "SuperDestinationExecutorMarkRootsAsUsed", accountRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(SuperDestinationExecutorSuperDestinationExecutorMarkRootsAsUsed)
				if err := _SuperDestinationExecutor.contract.UnpackLog(event, "SuperDestinationExecutorMarkRootsAsUsed", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event SuperDestinationExecutorMarkRootsAsUsed(address indexed account, bytes32[] roots)
func (_SuperDestinationExecutor *SuperDestinationExecutorFilterer) ParseSuperDestinationExecutorMarkRootsAsUsed(log types.Log) (*SuperDestinationExecutorSuperDestinationExecutorMarkRootsAsUsed, error) {
	event := new(SuperDestinationExecutorSuperDestinationExecutorMarkRootsAsUsed)
	if err := _SuperDestinationExecutor.contract.UnpackLog(event, "SuperDestinationExecutorMarkRootsAsUsed", log); err != nil {
		return nil, err
	}
...
// SuperDestinationExecutorSuperDestinationExecutorReceivedButRootUsedAlreadyIterator is returned from FilterSuperDestinationExecutorReceivedButRootUsedAlready and is used to iterate over the raw logs and unpacked data for SuperDestinationExecutorReceivedButRootUsedAlready events raised by the SuperDestinationExecutor contract.
type SuperDestinationExecutorSuperDestinationExecutorReceivedButRootUsedAlreadyIterator struct {
	Event *SuperDestinationExecutorSuperDestinationExecutorReceivedButRootUsedAlready // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *SuperDestinationExecutorSuperDestinationExecutorReceivedButRootUsedAlreadyIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(SuperDestinationExecutorSuperDestinationExecutorReceivedButRootUsedAlready)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *SuperDestinationExecutorSuperDestinationExecutorReceivedButRootUsedAlreadyIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *SuperDestinationExecutorSuperDestinationExecutorReceivedButRootUsedAlreadyIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// SuperDestinationExecutorSuperDestinationExecutorReceivedButRootUsedAlready represents a SuperDestinationExecutorReceivedButRootUsedAlready event raised by the SuperDestinationExecutor contract.
type SuperDestinationExecutorSuperDestinationExecutorReceivedButRootUsedAlready struct {
	Account common.Address
	Root    [32]byte
	Raw     types.Log // Blockchain specific contextual infos
}
...
func (_SuperDestinationExecutor *SuperDestinationExecutorFilterer) FilterSuperDestinationExecutorReceivedButRootUsedAlready(opts *bind.FilterOpts, account []common.Address, root [][32]byte) (*SuperDestinationExecutorSuperDestinationExecutorReceivedButRootUsedAlreadyIterator, error) {
	...
	logs, sub, err := _SuperDestinationExecutor.contract.FilterLogs(opts, "SuperDestinationExecutorReceivedButRootUsedAlready", accountRule, rootRule)
	if err != nil {
		return nil, err
	}
	return &SuperDestinationExecutorSuperDestinationExecutorReceivedButRootUsedAlreadyIterator{contract: _SuperDestinationExecutor.contract, event: "SuperDestinationExecutorReceivedButRootUsedAlready", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event SuperDestinationExecutorReceivedButRootUsedAlready(address indexed account, bytes32 indexed root)
func (_SuperDestinationExecutor *SuperDestinationExecutorFilterer) WatchSuperDestinationExecutorReceivedButRootUsedAlready(opts *bind.WatchOpts, sink chan<- *SuperDestinationExecutorSuperDestinationExecutorReceivedButRootUsedAlready, account []common.Address, root [][32]byte) (event.Subscription, error) {
	...
	logs, sub, err := _SuperDestinationExecutor.contract.WatchLogs(opts, "SuperDestinationExecutorReceivedButRootUsedAlready", accountRule, rootRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(SuperDestinationExecutorSuperDestinationExecutorReceivedButRootUsedAlready)
				if err := _SuperDestinationExecutor.contract.UnpackLog(event, "SuperDestinationExecutorReceivedButRootUsedAlready", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event SuperDestinationExecutorReceivedButRootUsedAlready(address indexed account, bytes32 indexed root)
func (_SuperDestinationExecutor *SuperDestinationExecutorFilterer) ParseSuperDestinationExecutorReceivedButRootUsedAlready(log types.Log) (*SuperDestinationExecutorSuperDestinationExecutorReceivedButRootUsedAlready, error) {
	event := new(SuperDestinationExecutorSuperDestinationExecutorReceivedButRootUsedAlready)
	if err := _SuperDestinationExecutor.contract.UnpackLog(event, "SuperDestinationExecutorReceivedButRootUsedAlready", log); err != nil {
		return nil, err
	}
