...
func (_SuperSponsorshipPaymaster *SuperSponsorshipPaymasterCaller) VERSION(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _SuperSponsorshipPaymaster.contract.Call(opts, &out, "VERSION")
...
//
// Solidity: function VERSION() view returns(uint256)
func (_SuperSponsorshipPaymaster *SuperSponsorshipPaymasterSession) VERSION() (*big.Int, error) {
...
//
// Solidity: function VERSION() view returns(uint256)
func (_SuperSponsorshipPaymaster *SuperSponsorshipPaymasterCallerSession) VERSION() (*big.Int, error) {
	return _SuperSponsorshipPaymaster.Contract.VERSION(&_SuperSponsorshipPaymaster.CallOpts)
}
