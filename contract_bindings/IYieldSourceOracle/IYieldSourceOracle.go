...
func (_IYieldSourceOracle *IYieldSourceOracleCaller) GetAssetOutputWithFees(opts *bind.CallOpts, yieldSourceOracleId [32]byte, yieldSourceAddress common.Address, assetOut common.Address, user common.Address, usedShares *big.Int) (*big.Int, error) {
	var out []interface{}
...
//
// Solidity: function getAssetOutputWithFees(bytes32 yieldSourceOracleId, address yieldSourceAddress, address assetOut, address user, uint256 usedShares) view returns(uint256)
func (_IYieldSourceOracle *IYieldSourceOracleSession) GetAssetOutputWithFees(yieldSourceOracleId [32]byte, yieldSourceAddress common.Address, assetOut common.Address, user common.Address, usedShares *big.Int) (*big.Int, error) {
...
//
// Solidity: function getAssetOutputWithFees(bytes32 yieldSourceOracleId, address yieldSourceAddress, address assetOut, address user, uint256 usedShares) view returns(uint256)
func (_IYieldSourceOracle *IYieldSourceOracleCallerSession) GetAssetOutputWithFees(yieldSourceOracleId [32]byte, yieldSourceAddress common.Address, assetOut common.Address, user common.Address, usedShares *big.Int) (*big.Int, error) {
	return _IYieldSourceOracle.Contract.GetAssetOutputWithFees(&_IYieldSourceOracle.CallOpts, yieldSourceOracleId, yieldSourceAddress, assetOut, user, usedShares)
}
...
func (_IYieldSourceOracle *IYieldSourceOracleCaller) GetWithdrawalShareOutput(opts *bind.CallOpts, yieldSourceAddress common.Address, assetIn common.Address, assetsIn *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _IYieldSourceOracle.contract.Call(opts, &out, "getWithdrawalShareOutput", yieldSourceAddress, assetIn, assetsIn)
...
//
// Solidity: function getWithdrawalShareOutput(address yieldSourceAddress, address assetIn, uint256 assetsIn) view returns(uint256)
func (_IYieldSourceOracle *IYieldSourceOracleSession) GetWithdrawalShareOutput(yieldSourceAddress common.Address, assetIn common.Address, assetsIn *big.Int) (*big.Int, error) {
	return _IYieldSourceOracle.Contract.GetWithdrawalShareOutput(&_IYieldSourceOracle.CallOpts, yieldSourceAddress, assetIn, assetsIn)
}

// GetWithdrawalShareOutput is a free data retrieval call binding the contract method 0x7eeb8107.
//
// Solidity: function getWithdrawalShareOutput(address yieldSourceAddress, address assetIn, uint256 assetsIn) view returns(uint256)
func (_IYieldSourceOracle *IYieldSourceOracleCallerSession) GetWithdrawalShareOutput(yieldSourceAddress common.Address, assetIn common.Address, assetsIn *big.Int) (*big.Int, error) {
	return _IYieldSourceOracle.Contract.GetWithdrawalShareOutput(&_IYieldSourceOracle.CallOpts, yieldSourceAddress, assetIn, assetsIn)
}
