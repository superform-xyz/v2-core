...
func (_StargateAdapterTest *StargateAdapterTestCaller) APPROVEANDSWAPOPENOCEANSPARKDEXHOOKKEY(opts *bind.CallOpts) (string, error) {
	var out []interface{}
	err := _StargateAdapterTest.contract.Call(opts, &out, "APPROVE_AND_SWAP_OPENOCEAN_SPARKDEX_HOOK_KEY")
...
//
// Solidity: function APPROVE_AND_SWAP_OPENOCEAN_SPARKDEX_HOOK_KEY() view returns(string)
func (_StargateAdapterTest *StargateAdapterTestSession) APPROVEANDSWAPOPENOCEANSPARKDEXHOOKKEY() (string, error) {
	return _StargateAdapterTest.Contract.APPROVEANDSWAPOPENOCEANSPARKDEXHOOKKEY(&_StargateAdapterTest.CallOpts)
}

// APPROVEANDSWAPOPENOCEANSPARKDEXHOOKKEY is a free data retrieval call binding the contract method 0xeaf33f2c.
//
// Solidity: function APPROVE_AND_SWAP_OPENOCEAN_SPARKDEX_HOOK_KEY() view returns(string)
func (_StargateAdapterTest *StargateAdapterTestCallerSession) APPROVEANDSWAPOPENOCEANSPARKDEXHOOKKEY() (string, error) {
	return _StargateAdapterTest.Contract.APPROVEANDSWAPOPENOCEANSPARKDEXHOOKKEY(&_StargateAdapterTest.CallOpts)
}
...
func (_StargateAdapterTest *StargateAdapterTestCaller) SWAPOPENOCEANSPARKDEXHOOKKEY(opts *bind.CallOpts) (string, error) {
	var out []interface{}
	err := _StargateAdapterTest.contract.Call(opts, &out, "SWAP_OPENOCEAN_SPARKDEX_HOOK_KEY")
...
//
// Solidity: function SWAP_OPENOCEAN_SPARKDEX_HOOK_KEY() view returns(string)
func (_StargateAdapterTest *StargateAdapterTestSession) SWAPOPENOCEANSPARKDEXHOOKKEY() (string, error) {
	return _StargateAdapterTest.Contract.SWAPOPENOCEANSPARKDEXHOOKKEY(&_StargateAdapterTest.CallOpts)
}

// SWAPOPENOCEANSPARKDEXHOOKKEY is a free data retrieval call binding the contract method 0x78a941d3.
//
// Solidity: function SWAP_OPENOCEAN_SPARKDEX_HOOK_KEY() view returns(string)
func (_StargateAdapterTest *StargateAdapterTestCallerSession) SWAPOPENOCEANSPARKDEXHOOKKEY() (string, error) {
	return _StargateAdapterTest.Contract.SWAPOPENOCEANSPARKDEXHOOKKEY(&_StargateAdapterTest.CallOpts)
}
