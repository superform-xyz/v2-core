...
func (_SpectraPTYieldSourceOracle *SpectraPTYieldSourceOracleCaller) SUPERLEDGERCONFIGURATION(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _SpectraPTYieldSourceOracle.contract.Call(opts, &out, "SUPER_LEDGER_CONFIGURATION")
...
func (_SpectraPTYieldSourceOracle *SpectraPTYieldSourceOracleCaller) GetAssetOutputWithFees(opts *bind.CallOpts, yieldSourceOracleId [32]byte, yieldSourceAddress common.Address, assetOut common.Address, user common.Address, usedShares *big.Int) (*big.Int, error) {
	var out []interface{}
...
//
// Solidity: function getAssetOutputWithFees(bytes32 yieldSourceOracleId, address yieldSourceAddress, address assetOut, address user, uint256 usedShares) view returns(uint256)
func (_SpectraPTYieldSourceOracle *SpectraPTYieldSourceOracleSession) GetAssetOutputWithFees(yieldSourceOracleId [32]byte, yieldSourceAddress common.Address, assetOut common.Address, user common.Address, usedShares *big.Int) (*big.Int, error) {
...
//
// Solidity: function getAssetOutputWithFees(bytes32 yieldSourceOracleId, address yieldSourceAddress, address assetOut, address user, uint256 usedShares) view returns(uint256)
func (_SpectraPTYieldSourceOracle *SpectraPTYieldSourceOracleCallerSession) GetAssetOutputWithFees(yieldSourceOracleId [32]byte, yieldSourceAddress common.Address, assetOut common.Address, user common.Address, usedShares *big.Int) (*big.Int, error) {
	return _SpectraPTYieldSourceOracle.Contract.GetAssetOutputWithFees(&_SpectraPTYieldSourceOracle.CallOpts, yieldSourceOracleId, yieldSourceAddress, assetOut, user, usedShares)
}
...
//
// Solidity: function getWithdrawalShareOutput(address ptAddress, address , uint256 assetsIn) view returns(uint256)
func (_SpectraPTYieldSourceOracle *SpectraPTYieldSourceOracleCaller) GetWithdrawalShareOutput(opts *bind.CallOpts, ptAddress common.Address, arg1 common.Address, assetsIn *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _SpectraPTYieldSourceOracle.contract.Call(opts, &out, "getWithdrawalShareOutput", ptAddress, arg1, assetsIn)
...
//
// Solidity: function getWithdrawalShareOutput(address ptAddress, address , uint256 assetsIn) view returns(uint256)
func (_SpectraPTYieldSourceOracle *SpectraPTYieldSourceOracleSession) GetWithdrawalShareOutput(ptAddress common.Address, arg1 common.Address, assetsIn *big.Int) (*big.Int, error) {
	return _SpectraPTYieldSourceOracle.Contract.GetWithdrawalShareOutput(&_SpectraPTYieldSourceOracle.CallOpts, ptAddress, arg1, assetsIn)
}

// GetWithdrawalShareOutput is a free data retrieval call binding the contract method 0x7eeb8107.
//
// Solidity: function getWithdrawalShareOutput(address ptAddress, address , uint256 assetsIn) view returns(uint256)
func (_SpectraPTYieldSourceOracle *SpectraPTYieldSourceOracleCallerSession) GetWithdrawalShareOutput(ptAddress common.Address, arg1 common.Address, assetsIn *big.Int) (*big.Int, error) {
	return _SpectraPTYieldSourceOracle.Contract.GetWithdrawalShareOutput(&_SpectraPTYieldSourceOracle.CallOpts, ptAddress, arg1, assetsIn)
}
