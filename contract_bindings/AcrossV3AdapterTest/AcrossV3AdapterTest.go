...
func (_AcrossV3AdapterTest *AcrossV3AdapterTestCaller) APPROVEANDSWAPOPENOCEANHOOKKEY(opts *bind.CallOpts) (string, error) {
	var out []interface{}
	err := _AcrossV3AdapterTest.contract.Call(opts, &out, "APPROVE_AND_SWAP_OPENOCEAN_HOOK_KEY")
...
//
// Solidity: function APPROVE_AND_SWAP_OPENOCEAN_HOOK_KEY() view returns(string)
func (_AcrossV3AdapterTest *AcrossV3AdapterTestSession) APPROVEANDSWAPOPENOCEANHOOKKEY() (string, error) {
	return _AcrossV3AdapterTest.Contract.APPROVEANDSWAPOPENOCEANHOOKKEY(&_AcrossV3AdapterTest.CallOpts)
}

// APPROVEANDSWAPOPENOCEANHOOKKEY is a free data retrieval call binding the contract method 0x2328f3a1.
//
// Solidity: function APPROVE_AND_SWAP_OPENOCEAN_HOOK_KEY() view returns(string)
func (_AcrossV3AdapterTest *AcrossV3AdapterTestCallerSession) APPROVEANDSWAPOPENOCEANHOOKKEY() (string, error) {
	return _AcrossV3AdapterTest.Contract.APPROVEANDSWAPOPENOCEANHOOKKEY(&_AcrossV3AdapterTest.CallOpts)
}
...
func (_AcrossV3AdapterTest *AcrossV3AdapterTestCaller) SWAPOPENOCEANHOOKKEY(opts *bind.CallOpts) (string, error) {
	var out []interface{}
	err := _AcrossV3AdapterTest.contract.Call(opts, &out, "SWAP_OPENOCEAN_HOOK_KEY")
...
//
// Solidity: function SWAP_OPENOCEAN_HOOK_KEY() view returns(string)
func (_AcrossV3AdapterTest *AcrossV3AdapterTestSession) SWAPOPENOCEANHOOKKEY() (string, error) {
	return _AcrossV3AdapterTest.Contract.SWAPOPENOCEANHOOKKEY(&_AcrossV3AdapterTest.CallOpts)
}

// SWAPOPENOCEANHOOKKEY is a free data retrieval call binding the contract method 0x4359f387.
//
// Solidity: function SWAP_OPENOCEAN_HOOK_KEY() view returns(string)
func (_AcrossV3AdapterTest *AcrossV3AdapterTestCallerSession) SWAPOPENOCEANHOOKKEY() (string, error) {
	return _AcrossV3AdapterTest.Contract.SWAPOPENOCEANHOOKKEY(&_AcrossV3AdapterTest.CallOpts)
}
